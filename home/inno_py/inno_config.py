...
gInnoTestTime     = 600
gInnoInitCmdStr   = 'innominer_%s -o %s -u %s -p \"%s\" --A1Pll1 %s --A1Pll2 %s --A1Pll3 %s --A1Pll4 %s --A1Pll5 %s --A1Pll6 %s --A1Pll7 %s --A1Pll8 %s --A1Vol1 %s --A1Vol2 %s --A1Vol3 %s --A1Vol4 %s --A1Vol5 %s --A1Vol6 %s --A1Vol7 %s --A1Vol8 %s --A1Fanmode %s --A1Fanspd %s %s --api-listen --syslog > /dev/null 2>&1 &'
gInnoCmdExtraDef  = ''
...
gInnoCmd2Pool     = 'innominer_%s -o %s -u %s -p \"%s\" -o %s -u %s -p \"%s\" --A1Pll1 %s --A1Pll2 %s --A1Pll3 %s --A1Pll4 %s --A1Pll5 %s --A1Pll6 %s --A1Pll7 %s --A1Pll8 %s --A1Vol1 %s --A1Vol2 %s --A1Vol3 %s --A1Vol4 %s --A1Vol5 %s --A1Vol6 %s --A1Vol7 %s --A1Vol8 %s --A1Fanmode %s --A1Fanspd %s %s --api-listen --syslog >/dev/null 2>&1 &'
gInnoCmd3Pool     = 'innominer_%s -o %s -u %s -p \"%s\" -o %s -u %s -p \"%s\" -o %s -u %s -p \"%s\" --A1Pll1 %s --A1Pll2 %s --A1Pll3 %s --A1Pll4 %s --A1Pll5 %s --A1Pll6 %s --A1Pll7 %s --A1Pll8 %s --A1Vol1 %s --A1Vol2 %s --A1Vol3 %s --A1Vol4 %s --A1Vol5 %s --A1Vol6 %s --A1Vol7 %s --A1Vol8 %s --A1Fanmode %s --A1Fanspd %s %s --api-listen --syslog >/dev/null 2>&1 &'
